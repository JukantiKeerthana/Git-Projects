  ...
  return (
    <div className='space-y-6'>
      <div className='flex items-center justify-between'>
        ...
        <button onClick={addEducation} className='flex items-center gap-2 px-3 py-1 text-sm bg-yellow-100 text-yellow-700 rounded-lg hover:bg-yellow-200 transition-colors'>
